...
public class TileInventoryMiniChest extends TileEntity implements IInventory {
	...
	public boolean isEmpty()
  {
	...
	public String getName() {
		return "container.famod_inventory_minichest.name";
	}
