...
public class ContainerInventoryMiniChest extends Container {
	...
	public ContainerInventoryMiniChest(InventoryPlayer invPlayer, TileInventoryMiniChest tileEntityInventoryBasic) {
