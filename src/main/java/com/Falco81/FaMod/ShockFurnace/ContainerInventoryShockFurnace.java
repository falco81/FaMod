...
public class ContainerInventoryShockFurnace extends Container {

	// Stores the tile entity instance for later use
	private TileInventoryShockFurnace tileInventoryFurnace;
	...
	public ContainerInventoryShockFurnace(InventoryPlayer invPlayer, TileInventoryShockFurnace tileInventoryFurnace) {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex)
	{
		...
		if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
			...
			if (!TileInventoryShockFurnace.getSmeltingResultForItem(sourceStack).isEmpty()){  //isEmptyItem
				if (!mergeItemStack(sourceStack, FIRST_INPUT_SLOT_INDEX, FIRST_INPUT_SLOT_INDEX + INPUT_SLOTS_COUNT, false)){
					return ItemStack.EMPTY;  //EMPTY_ITEM;
				}
			}	else if (TileInventoryShockFurnace.getItemBurnTime(sourceStack) > 0) {
	...
	public class SlotFuel extends Slot {
		...
		public boolean isItemValid(ItemStack stack) {
			return TileInventoryShockFurnace.isItemValidForFuelSlot(stack);
		}
	}
	...
	public class SlotSmeltableInput extends Slot {
		...
		@Override
		public boolean isItemValid(ItemStack stack) {
			return TileInventoryShockFurnace.isItemValidForInputSlot(stack);
		}
	}
	...
	public class SlotOutput extends Slot {
		...
		@Override
		public boolean isItemValid(ItemStack stack) {
			return TileInventoryShockFurnace.isItemValidForOutputSlot(stack);
		}
	}
}
