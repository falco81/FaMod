...
public class ShockFurnaceRecipes {
	   private static final ShockFurnaceRecipes SHOCK_SMELTING_BASE = new ShockFurnaceRecipes();
	     ...
	     */
	    public static ShockFurnaceRecipes instance()
	    {
	        return SHOCK_SMELTING_BASE;
	    }

	    private ShockFurnaceRecipes()
	    {
	    	//Copy default furnace recipy
