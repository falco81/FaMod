...
public class GuiInventoryShockFurnace extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation("famod", "textures/gui/inventory_shockfurnace_bg.png");
	private TileInventoryShockFurnace tileEntity;

	public GuiInventoryShockFurnace(InventoryPlayer invPlayer, TileInventoryShockFurnace tileInventoryFurnace) {
		super(new ContainerInventoryShockFurnace(invPlayer, tileInventoryFurnace));
