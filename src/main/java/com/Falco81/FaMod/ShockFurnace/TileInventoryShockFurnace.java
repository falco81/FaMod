...
public class TileInventoryShockFurnace extends TileEntity implements IInventory, ITickable {
	...
	public TileInventoryShockFurnace()
	{
	...
	public static ItemStack getSmeltingResultForItem(ItemStack stack) {
		return ShockFurnaceRecipes.instance().getSmeltingResult(stack);
		}
 ...
 */
  ...
  //------------------------
	...
	public String getName() {
		return "container.famod_inventory_shockfurnace.name";
	}
