...
public class ShockFurnace extends BlockContainer {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileInventoryShockFurnace();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
		...
		playerIn.openGui(FaMod.instance, GuiHandlerShockFurnace.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
