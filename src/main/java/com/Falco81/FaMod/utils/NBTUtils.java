...
public class NBTUtils {
		...
		private static final String[] STATEFUL_TAG_NAMES = { GUI_OPEN };
	    ...
	    public static boolean hasColor(ItemStack itemStack) {
	        return hasKey(itemStack, DISPLAY, NBTType.COMPOUND) && getTagCompound(itemStack, DISPLAY).hasKey(COLOR, NBTType.INT.ordinal());
	    }
	    ...
	    public static void setColor(ItemStack itemStack, int color) {
	        ...
	        if (itemStack != null) {
	            ...
	            if (itemStack.getTagCompound().hasKey(DISPLAY, NBTType.COMPOUND.ordinal())) {
	                ...
	                itemStack.getTagCompound().setTag(DISPLAY, displayTagCompound);
	            }
	        }
	    }
