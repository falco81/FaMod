...
public class FaModVillager implements IVillageTradeHandler  {
    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipes, Random random) {
        ...
        recipes.add(new MerchantRecipe(
           new ItemStack(Item.emerald, 5), new ItemStack(ModItems.FaModShockCoal, 64, 0)));   
   }


    @SuppressWarnings("static-access")
    public static void init(){
        VillagerRegistry.instance().registerVillagerType(Villagers.FAMODVILLAGER, "/mods/famod/mobs/villager.png"); //id must be greater than 6
        ...
        VillagerRegistry.instance().getRegisteredVillagers(); //not sure if this is required. But I didn't see a new one 
    }
}
