...
public class ShockFurnaceRecipes {
    private static final ShockFurnaceRecipes shocksmeltingBase = new ShockFurnaceRecipes();
     ...
     */
    public static final ShockFurnaceRecipes smelting() {
        return shocksmeltingBase;
    }
   ...
   /*     this.addSmelting(Block.oreIron.blockID, new ItemStack(Item.ingotIron),
        ...
        this.addSmelting(Item.beefRaw.itemID, new ItemStack(Item.beefCooked),
                0.35F);
        this.addSmelting(Item.chickenRaw.itemID, new ItemStack(
                Item.chickenCooked), 0.35F);
        ...
        this.addSmelting(Block.cactus.blockID, new ItemStack(Item.dyePowder, 1,
                2), 0.2F);
        this.addSmelting(Block.wood.blockID, new ItemStack(Item.coal, 1, 1),
                0.15F);
        this.addSmelting(Block.oreEmerald.blockID, new ItemStack(Item.emerald),
                1.0F);
        this.addSmelting(Item.potato.itemID, new ItemStack(Item.bakedPotato),
                0.35F);
        this.addSmelting(Block.netherrack.blockID, new ItemStack(
                Item.netherrackBrick), 0.1F);
        this.addSmelting(Block.oreCoal.blockID, new ItemStack(Item.coal), 0.1F);
        this.addSmelting(Block.oreRedstone.blockID,
                new ItemStack(Item.redstone), 0.7F);
