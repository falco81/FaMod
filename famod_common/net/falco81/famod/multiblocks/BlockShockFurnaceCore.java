...
public class BlockShockFurnaceCore extends BlockContainer {
    ...
    public BlockShockFurnaceCore(int blockId) {
        super(blockId, Material.rock);

        setUnlocalizedName("blockShockFurnaceCore");
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        faceIconUnlit = iconRegister
                .registerIcon(Reference.MOD_ID.toLowerCase() + ":"+"shockfurnaceaunctive");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (tileEntity != null) {
            ...
            if (tileEntity.getIsValid())
                player.openGui(FaMod.instance,Multiblocks.GUIIDs.multiFurnace, world, x, y, z);
    ...
    public TileEntity createNewTileEntity(World world) {
        return new TileEntityShockFurnaceCore();
    }
