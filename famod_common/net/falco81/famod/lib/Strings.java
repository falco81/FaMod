...
public class Strings {
    ...
    public static final String FAMODSAND_NAME = "FaModSand";
    public static final String FAMODBEDROCK_NAME = "FaModBedrock";
    ...
    public static final String FAMODBEDROCK_DISNAME = "FaModBedrock";
